...
def ensure_branch_exists(L, full_path, branch_tuple,AUTO_SET_MISSING_BRANCHES=True, branch_type_mapping={}):
    """
...
def fill_branches_from_export_file(
    ...
    for (bp, var), group in df.groupby(["Branch Path", "Variable"]):
        ...
        # Set the variable
        set_success = safe_set_variable(branch, var, expr, context=bp)
