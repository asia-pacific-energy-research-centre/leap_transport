...
PROXIED_SOURCE_ROWS_WITH_NO_ACTIVITY = {#THESE SHOULD BE ALL PROXIES WITH #PROXY IN THE COMMENTS ABOVE
    ...
    # Efuel proxies
    ("freight", "rail", "all", "rail_biodiesel", "Efuel"): ("freight", "rail", "all", "rail_diesel", "Diesel"),
    ("freight", "road", "ht", "erev_d", "Efuel"): ("freight", "road", "ht", "phev_d", "Diesel"),
    ("freight", "road", "ht", "ice_d", "Efuel"): ("freight", "road", "ht", "ice_d", "Diesel"),
    ("freight", "road", "ht", "phev_d", "Efuel"): ("freight", "road", "ht", "phev_d", "Diesel"),
    ("freight", "road", "lcv", "ice_d", "Efuel"): ("freight", "road", "lcv", "ice_d", "Diesel"),
    ("freight", "road", "lcv", "phev_d", "Efuel"): ("freight", "road", "lcv", "phev_d", "Diesel"),
    ("freight", "road", "mt", "erev_d", "Efuel"): ("freight", "road", "mt", "phev_d", "Diesel"),
    ("freight", "road", "mt", "ice_d", "Efuel"): ("freight", "road", "mt", "ice_d", "Diesel"),
    ("freight", "road", "mt", "phev_d", "Efuel"): ("freight", "road", "mt", "phev_d", "Diesel"),
    ("freight", "ship", "all", "ship_biodiesel", "Efuel"): ("freight", "ship", "all", "ship_diesel", "Diesel"),
    ("passenger", "rail", "all", "rail_biodiesel", "Efuel"): ("passenger", "rail", "all", "rail_diesel", "Diesel"),
    ("passenger", "road", "2w", "ice_d", "Efuel"): ("passenger", "road", "2w", "ice_d", "Diesel"),
    ("passenger", "road", "bus", "erev_d", "Efuel"): ("passenger", "road", "bus", "phev_d", "Diesel"),
    ("passenger", "road", "bus", "ice_d", "Efuel"): ("passenger", "road", "bus", "ice_d", "Diesel"),
    ("passenger", "road", "bus", "phev_d", "Efuel"): ("passenger", "road", "bus", "ice_d", "Diesel"),
    ("passenger", "road", "car", "hev_d", "Efuel"): ("passenger", "road", "car", "ice_d", "Diesel"),
    ("passenger", "road", "car", "ice_d", "Efuel"): ("passenger", "road", "car", "ice_d", "Diesel"),
    ("passenger", "road", "car", "phev_d", "Efuel"): ("passenger", "road", "car", "phev_d", "Diesel"),
    ("passenger", "road", "lt", "hev_d", "Efuel"): ("passenger", "road", "lt", "ice_d", "Diesel"),
    ("passenger", "road", "lt", "ice_d", "Efuel"): ("passenger", "road", "lt", "ice_d", "Diesel"),
    ("passenger", "road", "lt", "phev_d", "Efuel"): ("passenger", "road", "lt", "phev_d", "Diesel"),
    ("passenger", "road", "suv", "hev_d", "Efuel"): ("passenger", "road", "suv", "ice_d", "Diesel"),
    ("passenger", "road", "suv", "ice_d", "Efuel"): ("passenger", "road", "suv", "ice_d", "Diesel"),
    ("passenger", "road", "suv", "phev_d", "Efuel"): ("passenger", "road", "suv", "phev_d", "Diesel"),
    ("passenger", "ship", "all", "ship_biodiesel", "Efuel"): ("passenger", "ship", "all", "ship_diesel", "Diesel"),
}
