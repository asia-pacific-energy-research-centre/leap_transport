#%%
import pandas as pd
from config.basic_mappings import ALL_PATHS_SOURCE, ALL_PATHS_LEAP
from config.branch_expression_mapping import LEAP_BRANCH_TO_EXPRESSION_MAPPING
SHORTNAME_TO_LEAP_BRANCHES = {
    ...
    "Fuel (road)": [
        ...
        ("Passenger road", "LPVs", "ICE small", "Motor gasoline"),
        ...
        ("Passenger road", "LPVs", "ICE small", "Efuel"),
        ("Passenger road", "LPVs", "ICE medium", "Motor gasoline"),
        ("Passenger road", "LPVs", "ICE medium", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "ICE medium", "Natural gas"),
        ("Passenger road", "LPVs", "ICE medium", "Biogas"),
        ("Passenger road", "LPVs", "ICE large", "Motor gasoline"),
        ("Passenger road", "LPVs", "ICE large", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "ICE large", "Natural gas"),
        ("Passenger road", "LPVs", "ICE large", "Biogas"),
        ("Passenger road", "LPVs", "PHEV small", "Electricity"),
        ("Passenger road", "LPVs", "PHEV small", "Motor gasoline"),
        ("Passenger road", "LPVs", "PHEV small", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "PHEV medium", "Motor gasoline"),
        ("Passenger road", "LPVs", "PHEV medium", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "PHEV large", "Motor gasoline"),
        ("Passenger road", "LPVs", "PHEV large", "Gas and diesel oil"),
        ("Passenger road", "LPVs", "PHEV large", "Efuel"),
        ("Passenger road", "LPVs", "PHEV large", "Biogasoline"),
        ("Passenger road", "LPVs", "PHEV large", "Biodiesel"),
        ("Passenger road", "LPVs", "PHEV large", "Efuel"),
        ("Passenger road", "LPVs", "HEV small", "Motor gasoline"),
        ("Passenger road", "LPVs", "HEV small", "Gas and diesel oil"),
        ("Passenger road", "LPVs", "HEV small", "Efuel"),
        ("Passenger road", "LPVs", "HEV small", "Biogasoline"),
        ("Passenger road", "LPVs", "HEV small", "Biodiesel"),
        ("Passenger road", "LPVs", "HEV small", "Efuel"),
        ("Passenger road", "LPVs", "HEV medium", "Motor gasoline"),
        ("Passenger road", "LPVs", "HEV medium", "Gas and diesel oil"),
        ("Passenger road", "LPVs", "HEV medium", "Efuel"),
        ("Passenger road", "LPVs", "HEV medium", "Biogasoline"),
        ("Passenger road", "LPVs", "HEV medium", "Biodiesel"),
        ("Passenger road", "LPVs", "HEV medium", "Efuel"),
        ("Passenger road", "LPVs", "HEV large", "Motor gasoline"),
        ("Passenger road", "LPVs", "HEV large", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "EREV small", "Motor gasoline"),
        ("Passenger road", "LPVs", "EREV small", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "EREV medium", "Motor gasoline"),
        ("Passenger road", "LPVs", "EREV medium", "Gas and diesel oil"),
        ...
        ("Passenger road", "LPVs", "EREV large", "Motor gasoline"),
        ("Passenger road", "LPVs", "EREV large", "Gas and diesel oil"),
        ...
        ("Passenger road", "Buses", "EREV", "Motor gasoline"),
        ("Passenger road", "Buses", "EREV", "Gas and diesel oil"),
        ("Passenger road", "Buses", "EREV", "Efuel"),
        ("Passenger road", "Buses", "EREV", "Biogasoline"),
        ("Passenger road", "Buses", "EREV", "Biodiesel"),
        ("Passenger road", "Buses", "EREV", "Efuel"),
        # Motorcycles fuels
        ("Passenger road", "Motorcycles", "ICE", "Motor gasoline"),
        ("Passenger road", "Motorcycles", "ICE", "Gas and diesel oil"),
        ...
        # Freight road fuels
        ("Freight road", "Trucks", "ICE heavy", "Motor gasoline"),
        ("Freight road", "Trucks", "ICE heavy", "Gas and diesel oil"),
        ...
        ("Freight road", "Trucks", "ICE heavy", "Natural gas"),
        ("Freight road", "Trucks", "ICE heavy", "LNG"),
        ("Freight road", "Trucks", "ICE heavy", "Biogas"),
        ("Freight road", "Trucks", "ICE medium", "Motor gasoline"),
        ("Freight road", "Trucks", "ICE medium", "Gas and diesel oil"),
        ...
        ("Freight road", "Trucks", "ICE medium", "Natural gas"),
        ...
        ("Freight road", "Trucks", "EREV medium", "Motor gasoline"),
        ("Freight road", "Trucks", "EREV medium", "Gas and diesel oil"),
        ...
        ("Freight road", "Trucks", "EREV heavy", "Motor gasoline"),
        ("Freight road", "Trucks", "EREV heavy", "Gas and diesel oil"),
        ...
        ("Freight road", "Trucks", "PHEV heavy", "Gas and diesel oil"),
        ...
        ("Freight road", "Trucks", "PHEV medium", "Gas and diesel oil"),
        ...
        ("Freight road", "LCVs", "EREV", "Motor gasoline"),
        ("Freight road", "LCVs", "EREV", "Gas and diesel oil"),
    ...
    "Fuel (non-road)": [
        ...
        ("Passenger non road", "Air", "Kerosene type jet fuel"),
        ("Passenger non road", "Air", "Efuel"),
        ("Passenger non road", "Air", "Aviation gasoline"),
        ("Passenger non road", "Air", "Bio jet kerosene"),
        
        ("Passenger non road", "Rail", "Electricity"),
        ("Passenger non road", "Rail", "Gas and diesel oil"),
        ...
        ("Passenger non road", "Shipping", "Motor gasoline"),
        ...
        ("Freight non road", "Air", "Kerosene type jet fuel"),
        ("Freight non road", "Air", "Efuel"),
        ("Freight non road", "Air", "Aviation gasoline"),
        ("Freight non road", "Air", "Bio jet kerosene"),
        
        ("Freight non road", "Rail", "Electricity"),
        ("Freight non road", "Rail", "Gas and diesel oil"),
    ...
    "Others (level 2)": [
        ...
        ("Pipeline transport", "Gas and diesel oil"),
...
LEAP_BRANCH_TO_SOURCE_MAP = {
    ...
    ("Passenger non road", "Air", "Kerosene type jet fuel"):        ("passenger", "air", "all", "air_jet_fuel", "Kerosene type jet fuel"),
    ...
    ("Passenger non road", "Air", "Bio jet kerosene"):         ("passenger", "air", "all", "air_jet_fuel", "Bio jet kerosene"),

    ("Passenger non road", "Rail", "Electricity"):    ("passenger", "rail", "all", "rail_electricity", "Electricity"),
    ("Passenger non road", "Rail", "Gas and diesel oil"):         ("passenger", "rail", "all", "rail_diesel", "Gas and diesel oil"),
    ...
    ("Passenger non road", "Rail", "Other bituminous coal"):           ("passenger", "rail", "all", "rail_coal", "Other bituminous coal"),
    ...
    ("Passenger non road", "Shipping", "Gas and diesel oil"):     ("passenger", "ship", "all", "ship_diesel", "Gas and diesel oil"),
    ...
    ("Passenger non road", "Shipping", "Motor gasoline"):   ("passenger", "ship", "all", "ship_gasoline", "Motor gasoline"),
    ...
    ("Freight non road", "Air", "Kerosene type jet fuel"):          ("freight", "air", "all", "air_jet_fuel", "Kerosene type jet fuel"),
    ...
    ("Freight non road", "Air", "Bio jet kerosene"):           ("freight", "air", "all", "air_jet_fuel", "Bio jet kerosene"),

    ("Freight non road", "Rail", "Electricity"):      ("freight", "rail", "all", "rail_electricity", "Electricity"),
    ("Freight non road", "Rail", "Gas and diesel oil"):           ("freight", "rail", "all", "rail_diesel", "Gas and diesel oil"),
    ...
    ("Freight non road", "Rail", "Other bituminous coal"):             ("freight", "rail", "all", "rail_coal", "Other bituminous coal"),
    ...
    ("Freight non road", "Shipping", "Gas and diesel oil"):       ("freight", "ship", "all", "ship_diesel", "Gas and diesel oil"),
    ...
    ("Freight non road", "Shipping", "Motor gasoline"):     ("freight", "ship", "all", "ship_gasoline", "Motor gasoline"),
    ...
    ("Passenger road", "LPVs", "ICE small", "Motor gasoline"):      ("passenger", "road", "car", "ice_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "ICE small", "Gas and diesel oil"):        ("passenger", "road", "car", "ice_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "ICE medium", "Motor gasoline"):     ("passenger", "road", "suv", "ice_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "ICE medium", "Gas and diesel oil"):       ("passenger", "road", "suv", "ice_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "ICE medium", "Natural gas"):          ("passenger", "road", "suv", "cng", "Natural gas"),
    ("Passenger road", "LPVs", "ICE medium", "Biogas"):       ("passenger", "road", "suv", "cng", "Biogas"), #proxy?

    ("Passenger road", "LPVs", "ICE large", "Motor gasoline"):      ("passenger", "road", "lt", "ice_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "ICE large", "Gas and diesel oil"):        ("passenger", "road", "lt", "ice_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "ICE large", "Natural gas"):           ("passenger", "road", "lt", "cng", "Natural gas"),
    ...
    ("Passenger road", "LPVs", "PHEV small", "Motor gasoline"):     ("passenger", "road", "car", "phev_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "PHEV small", "Gas and diesel oil"):       ("passenger", "road", "car", "phev_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "PHEV medium", "Motor gasoline"):    ("passenger", "road", "suv", "phev_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "PHEV medium", "Gas and diesel oil"):      ("passenger", "road", "suv", "phev_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "PHEV large", "Motor gasoline"):     ("passenger", "road", "lt", "phev_g", "Motor gasoline"),
    ("Passenger road", "LPVs", "PHEV large", "Gas and diesel oil"):       ("passenger", "road", "lt", "phev_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "LPVs", "HEV small", "Motor gasoline"):      ("passenger", "road", "car", "hev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "HEV small", "Gas and diesel oil"):        ("passenger", "road", "car", "hev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "LPVs", "HEV medium", "Motor gasoline"):     ("passenger", "road", "suv", "hev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "HEV medium", "Gas and diesel oil"):       ("passenger", "road", "suv", "hev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "LPVs", "HEV large", "Motor gasoline"):      ("passenger", "road", "lt", "hev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "HEV large", "Gas and diesel oil"):        ("passenger", "road", "lt", "hev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "LPVs", "EREV small", "Motor gasoline"):      ("passenger", "road", "car", "erev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "EREV small", "Gas and diesel oil"):        ("passenger", "road", "car", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "LPVs", "EREV medium", "Motor gasoline"):     ("passenger", "road", "suv", "erev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "EREV medium", "Gas and diesel oil"):       ("passenger", "road", "suv", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "LPVs", "EREV large", "Motor gasoline"):      ("passenger", "road", "lt", "erev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "LPVs", "EREV large", "Gas and diesel oil"):        ("passenger", "road", "lt", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Passenger road", "Buses", "ICE", "Gas and diesel oil"):             ("passenger", "road", "bus", "ice_d", "Gas and diesel oil"),
    ("Passenger road", "Buses", "ICE", "Efuel"):             ("passenger", "road", "bus", "ice_d", "Efuel"),
    ("Passenger road", "Buses", "ICE", "Motor gasoline"):           ("passenger", "road", "bus", "ice_g", "Motor gasoline"),
    ("Passenger road", "Buses", "ICE", "LPG"):                ("passenger", "road", "bus", "lpg", "LPG"),
    ("Passenger road", "Buses", "ICE", "Natural gas"):                ("passenger", "road", "bus", "cng", "Natural gas"),
    ...
    ("Passenger road", "Buses", "PHEV", "Motor gasoline"):          ("passenger", "road", "bus", "phev_g", "Motor gasoline"),
    ("Passenger road", "Buses", "PHEV", "Gas and diesel oil"):            ("passenger", "road", "bus", "phev_d", "Gas and diesel oil"),
    ...
    ("Passenger road", "Buses", "EREV", "Motor gasoline"):          ("passenger", "road", "bus", "erev_g", "Motor gasoline"), #proxy?
    ("Passenger road", "Buses", "EREV", "Gas and diesel oil"):            ("passenger", "road", "bus", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    # =========================
    ("Passenger road", "Motorcycles", "ICE", "Motor gasoline"):     ("passenger", "road", "2w", "ice_g", "Motor gasoline"),
    ("Passenger road", "Motorcycles", "ICE", "Gas and diesel oil"):       ("passenger", "road", "2w", "ice_d", "Gas and diesel oil"),
    ...
    # =========================
    ("Freight road", "Trucks", "ICE heavy", "Motor gasoline"):      ("freight", "road", "ht", "ice_g", "Motor gasoline"),
    ("Freight road", "Trucks", "ICE heavy", "Gas and diesel oil"):        ("freight", "road", "ht", "ice_d", "Gas and diesel oil"),
    ...
    ("Freight road", "Trucks", "ICE heavy", "Natural gas"):           ("freight", "road", "ht", "cng", "Natural gas"),
    ...
    ("Freight road", "Trucks", "ICE medium", "Motor gasoline"):     ("freight", "road", "mt", "ice_g", "Motor gasoline"),
    ("Freight road", "Trucks", "ICE medium", "Gas and diesel oil"):       ("freight", "road", "mt", "ice_d", "Gas and diesel oil"),
    ...
    ("Freight road", "Trucks", "ICE medium", "Natural gas"):          ("freight", "road", "mt", "cng", "Natural gas"),
    ...
    ("Freight road", "Trucks", "EREV medium", "Motor gasoline"):    ("freight", "road", "mt", "erev_g", "Motor gasoline"), #proxy?
    ("Freight road", "Trucks", "EREV medium", "Electricity"): ("freight", "road", "mt", "erev_g", "Electricity"), #proxy?
    ("Freight road", "Trucks", "EREV medium", "Gas and diesel oil"):      ("freight", "road", "mt", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Freight road", "Trucks", "EREV heavy", "Motor gasoline"):     ("freight", "road", "ht", "erev_g", "Motor gasoline"), #proxy?
    ("Freight road", "Trucks", "EREV heavy", "Electricity"):  ("freight", "road", "ht", "erev_g", "Electricity"), #proxy?
    ("Freight road", "Trucks", "EREV heavy", "Gas and diesel oil"):       ("freight", "road", "ht", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Freight road", "Trucks", "PHEV medium", "Motor gasoline"):    ("freight", "road", "mt", "phev_g", "Motor gasoline"),
    ("Freight road", "Trucks", "PHEV medium", "Electricity"): ("freight", "road", "mt", "phev_g", "Electricity"),
    ("Freight road", "Trucks", "PHEV medium", "Gas and diesel oil"):      ("freight", "road", "mt", "phev_d", "Gas and diesel oil"),
    ...
    ("Freight road", "Trucks", "PHEV heavy", "Motor gasoline"):     ("freight", "road", "ht", "phev_g", "Motor gasoline"),
    ("Freight road", "Trucks", "PHEV heavy", "Electricity"):  ("freight", "road", "ht", "phev_g", "Electricity"),
    ("Freight road", "Trucks", "PHEV heavy", "Gas and diesel oil"):       ("freight", "road", "ht", "phev_d", "Gas and diesel oil"),
    ...
    # =========================
    ("Freight road", "LCVs", "ICE", "Motor gasoline"):              ("freight", "road", "lcv", "ice_g", "Motor gasoline"),
    ("Freight road", "LCVs", "ICE", "Gas and diesel oil"):                ("freight", "road", "lcv", "ice_d", "Gas and diesel oil"),
    ...
    ("Freight road", "LCVs", "ICE", "Natural gas"):                   ("freight", "road", "lcv", "cng", "Natural gas"),
    ...
    ("Freight road", "LCVs", "PHEV", "Motor gasoline"):             ("freight", "road", "lcv", "phev_g", "Motor gasoline"),
    ("Freight road", "LCVs", "PHEV", "Gas and diesel oil"):               ("freight", "road", "lcv", "phev_d", "Gas and diesel oil"),
    ...
    ("Freight road", "LCVs", "EREV", "Motor gasoline"):     ("freight", "road", "lcv", "erev_g", "Motor gasoline"), #proxy?
    ("Freight road", "LCVs", "EREV", "Electricity"):  ("freight", "road", "lcv", "erev_g", "Electricity"), #proxy?
    ("Freight road", "LCVs", "EREV", "Gas and diesel oil"):       ("freight", "road", "lcv", "erev_d", "Gas and diesel oil"), #proxy?
    ...
    ("Pipeline transport", "Gas and diesel oil"): ("Pipeline transport", "Gas and diesel oil"),
...
PROXIED_SOURCE_ROWS_WITH_NO_ACTIVITY = {#THESE SHOULD BE ALL PROXIES WITH #PROXY IN THE COMMENTS ABOVE
    ...
    # air
    # ("passenger", "air", "all", "air_biojet", "Bio jet kerosene"): ("passenger", "air", "all", "air_jet_fuel", "Kerosene type jet fuel"),
    # ("freight", "air", "all", "air_biojet", "Bio jet kerosene"): ("freight", "air", "all", "air_jet_fuel", "Kerosene type jet fuel"),

    # Freight rail
    # ("freight", "rail", "all", "rail_biodiesel", "Biodiesel"): ("freight", "rail", "all", "rail_diesel", "Gas and diesel oil"),
    ("freight", "rail", "all", "rail_hydrogen", "Hydrogen"): ("freight", "rail", "all", "rail_electricity", "Electricity"),
    
    #LCVs
    ("freight", "road", "lcv", "cng", "Biogas"): ("freight", "road", "lcv", "cng", "Natural gas"),
    
    ("freight", "road", "lcv", "erev_g", "Motor gasoline"): ("freight", "road", "lcv", "phev_g", "Motor gasoline"),
    ("freight", "road", "lcv", "erev_g", "Electricity"):  ("freight", "road", "lcv", "phev_g", "Electricity"),
    ("freight", "road", "lcv", "erev_d", "Gas and diesel oil"):       ("freight", "road", "lcv", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "lcv", "erev_d", "Efuel"):       ("freight", "road", "lcv", "phev_d", "Efuel"),
    ("freight", "road", "lcv", "erev_d", "Biodiesel"): ("freight", "road", "lcv", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "lcv", "erev_g", "Biogasoline"):   ("freight", "road", "lcv", "phev_g", "Motor gasoline"),
    
    ("freight", "road", "lcv", "erev_d"): ("Combined freight", "road", "lcv", "phev"),
    
    # Freight road heavy trucks
    ("freight", "road", "ht", "cng", "Biogas"): ("freight", "road", "ht", "cng", "Natural gas"),
    
    ("freight", "road", "ht", "erev_d", "Biodiesel"): ("freight", "road", "ht", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "ht", "erev_d", "Gas and diesel oil"): ("freight", "road", "ht", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "ht", "erev_g", "Biogasoline"): ("freight", "road", "ht", "phev_g", "Motor gasoline"),
    ("freight", "road", "ht", "erev_g", "Electricity"): ("freight", "road", "ht", "phev_g", "Electricity"),
    ("freight", "road", "ht", "erev_g", "Motor gasoline"): ("freight", "road", "ht", "phev_g", "Motor gasoline"),
    ...
    ("freight", "road", "mt", "cng", "Biogas"): ("freight", "road", "mt", "cng", "Natural gas"),
    
    ("freight", "road", "mt", "erev_d", "Biodiesel"): ("freight", "road", "mt", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "mt", "erev_d", "Gas and diesel oil"): ("freight", "road", "mt", "phev_d", "Gas and diesel oil"),
    ("freight", "road", "mt", "erev_g", "Biogasoline"): ("freight", "road", "mt", "phev_g", "Motor gasoline"),
    ("freight", "road", "mt", "erev_g", "Electricity"): ("freight", "road", "mt", "phev_g", "Electricity"),
    ("freight", "road", "mt", "erev_g", "Motor gasoline"): ("freight", "road", "mt", "phev_g", "Motor gasoline"),
    ...
    # Passenger road buses
    ("passenger", "road", "bus", "cng", "Biogas"): ("passenger", "road", "bus", "cng", "Natural gas"),
    
    ("passenger", "road", "bus", "erev_g", "Electricity"): ("passenger", "road", "bus", "phev_g", "Electricity"),
    ("passenger", "road", "bus", "erev_g", "Motor gasoline"): ("passenger", "road", "bus", "phev_g", "Motor gasoline"),
    ("passenger", "road", "bus", "erev_d", "Gas and diesel oil"): ("passenger", "road", "bus", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "bus", "erev_g", "Biogasoline"): ("passenger", "road", "bus", "phev_g", "Motor gasoline"),
    ("passenger", "road", "bus", "erev_d", "Biodiesel"): ("passenger", "road", "bus", "phev_d", "Gas and diesel oil"),
    ...
    # Passenger road cars
    ("passenger", "road", "car", "hev_d", "Biodiesel"): ("passenger", "road", "car", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "car", "hev_d", "Gas and diesel oil"): ("passenger", "road", "car", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "car", "hev_g", "Biogasoline"): ("passenger", "road", "car", "ice_g", "Motor gasoline"),
    ("passenger", "road", "car", "hev_g", "Motor gasoline"): ("passenger", "road", "car", "ice_g", "Motor gasoline"),
    ("passenger", "road", "car", "hev_g", "Efuel"): ("passenger", "road", "car", "ice_g", "Efuel"),
    
    ("passenger", "road", "car", "erev_g", "Motor gasoline"): ("passenger", "road", "car", "phev_g", "Motor gasoline"),
    ("passenger", "road", "car", "erev_g", "Electricity"): ("passenger", "road", "car", "phev_g", "Electricity"),
    ("passenger", "road", "car", "erev_d", "Gas and diesel oil"): ("passenger", "road", "car", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "car", "erev_g", "Efuel"): ("passenger", "road", "car", "phev_d", "Efuel"),
    ("passenger", "road", "car", "erev_d", "Biodiesel"): ("passenger", "road", "car", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "car", "erev_g", "Biogasoline"): ("passenger", "road", "car", "phev_g", "Motor gasoline"),
    ...
    ("passenger", "road", "lt", "cng", "Biogas"): ("passenger", "road", "lt", "cng", "Natural gas"),
    ("passenger", "road", "lt", "hev_d", "Biodiesel"): ("passenger", "road", "lt", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "lt", "hev_d", "Gas and diesel oil"): ("passenger", "road", "lt", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "lt", "hev_g", "Biogasoline"): ("passenger", "road", "lt", "ice_g", "Motor gasoline"),
    ("passenger", "road", "lt", "hev_g", "Motor gasoline"): ("passenger", "road", "lt", "ice_g", "Motor gasoline"),
    ("passenger", "road", "lt", "hev_g", "Efuel"): ("passenger", "road", "lt", "ice_g", "Efuel"),
    
    ("passenger", "road", "lt", "erev_g", "Motor gasoline"): ("passenger", "road", "lt", "phev_g", "Motor gasoline"),
    ("passenger", "road", "lt", "erev_g", "Electricity"): ("passenger", "road", "lt", "phev_g", "Electricity"),
    ("passenger", "road", "lt", "erev_d", "Gas and diesel oil"): ("passenger", "road", "lt", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "lt", "erev_g", "Efuel"): ("passenger", "road", "lt", "phev_d", "Efuel"),
    ("passenger", "road", "lt", "erev_d", "Biodiesel"): ("passenger", "road", "lt", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "lt", "erev_g", "Biogasoline"): ("passenger", "road", "lt", "phev_g", "Motor gasoline"),
    
    ("passenger", "road", "lt", "hev"): ("Combined passenger", "road", "lt", "ice"),
    ("passenger", "road", "lt", "erev_g"): ("Combined passenger", "road", "lt", "phev"),
    
    # Passenger road SUVs
    ("passenger", "road", "suv", "cng", "Biogas"): ("passenger", "road", "suv", "cng", "Natural gas"),
    ("passenger", "road", "suv", "hev_d", "Biodiesel"): ("passenger", "road", "suv", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "suv", "hev_d", "Gas and diesel oil"): ("passenger", "road", "suv", "ice_d", "Gas and diesel oil"),
    ("passenger", "road", "suv", "hev_g", "Biogasoline"): ("passenger", "road", "suv", "ice_g", "Motor gasoline"),
    ("passenger", "road", "suv", "hev_g", "Motor gasoline"): ("passenger", "road", "suv", "ice_g", "Motor gasoline"),
    ("passenger", "road", "suv", "hev_g", "Efuel"): ("passenger", "road", "suv", "ice_g", "Efuel"),
    
    ("passenger", "road", "suv", "erev_g", "Motor gasoline"): ("passenger", "road", "suv", "phev_g", "Motor gasoline"),
    ("passenger", "road", "suv", "erev_g", "Electricity"): ("passenger", "road", "suv", "phev_g", "Electricity"),
    ("passenger", "road", "suv", "erev_d", "Gas and diesel oil"): ("passenger", "road", "suv", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "suv", "erev_g", "Efuel"): ("passenger", "road", "suv", "phev_d", "Efuel"),
    ("passenger", "road", "suv", "erev_d", "Biodiesel"): ("passenger", "road", "suv", "phev_d", "Gas and diesel oil"),
    ("passenger", "road", "suv", "erev_g", "Biogasoline"): ("passenger", "road", "suv", "phev_g", "Motor gasoline"),
    
    ("passenger", "road", "suv", "hev"): ("Combined passenger", "road", "suv", "ice"),
    ("passenger", "road", "suv", "erev_g"): ("Combined passenger", "road", "suv", "phev"),
    
    # # Passenger shipping
    # ("passenger", "ship", "all", "ship_biodiesel", "Biodiesel"): ("passenger", "ship", "all", "ship_diesel", "Gas and diesel oil"),
    # ("passenger", "ship", "all", "ship_biogasoline", "Biogasoline"): ("passenger", "ship", "all", "ship_gasoline", "Motor gasoline"),
}
...
def check_LEAP_BRANCH_TO_SOURCE_MAP_for_missing_proxies_and_combinations(LEAP_BRANCH_TO_SOURCE_MAP, PROXIED_SOURCE_ROWS_WITH_NO_ACTIVITY, COMBINATION_SOURCE_ROWS):
    ...
    for source_value in all_source_values:
        ...
        if source_value not in ALL_PATHS_SOURCE:
            ...
            if source_value[-1] in ["Efuel", "Bio jet kerosene", "Biogasoline", "Biodiesel", "Biogas"]:
                continue
            if len(matches) == 0:
                breakpoint()
...
def create_new_source_rows_based_on_proxies_with_no_activity(source_df, strict_missing=False):
    ...
    for new_src_tuple, src_tuple in PROXIED_SOURCE_ROWS_WITH_NO_ACTIVITY.items():
        ...
        # Skip proxy creation if the target tuple already exists in the source data
        # or has already been created by an earlier proxy (avoid duplicates).
        existing_df = source_df if new_df_rows.empty else pd.concat([source_df, new_df_rows], ignore_index=True)
        target_mask = pd.Series(True, index=existing_df.index)
        for i, col in enumerate(source_cols):
            target_mask &= existing_df[col] == new_src_tuple[i]
        if target_mask.any():
            continue
...
def _unique_tuples_preserve_order(source_tuples_list):
    """Return source tuples with duplicates removed, preserving order."""
    seen = set()
    ordered = []
    for tup in source_tuples_list:
        key = tuple(tup)
        if key in seen:
            continue
        seen.add(key)
...
def _infer_additional_road_combination_tuples(source_df, new_src_tuple):
    """
    Infer missing road tuples for Combined-* aggregate rows.

    This keeps COMBINATION_SOURCE_ROWS maintainable by auto-including any
    real source tuples that fit the aggregate definition (e.g. LPG/CNG rows).
    """
    if len(new_src_tuple) < 3:
        return []
    transport_type, medium, vehicle_type = new_src_tuple[:3]
    if str(medium).strip().lower() != "road":
        return []
    if not str(transport_type).strip().lower().startswith("combined "):
        return []

    base_transport = str(transport_type).strip()[len("Combined ") :].strip().lower()
    vehicle_key = str(vehicle_type).strip().lower()
    road_vehicle_map = {
        "truck": ["ht", "mt"],
        "lpv": ["car", "suv", "lt"],
    }
    source_vehicle_types = road_vehicle_map.get(vehicle_key, [vehicle_key])

    drive_filters = None
    if len(new_src_tuple) >= 4 and pd.notna(new_src_tuple[3]):
        combined_drive = str(new_src_tuple[3]).strip().lower()
        drive_map = {
            "ice": ["ice_d", "ice_g"],
            "phev": ["phev_d", "phev_g"],
            "erev": ["erev_d", "erev_g"],
        ...
        drive_filters = drive_map.get(combined_drive, [combined_drive])

    fuel_filter = None
    if len(new_src_tuple) >= 5 and pd.notna(new_src_tuple[4]):
        fuel_filter = str(new_src_tuple[4]).strip()

    working = source_df.copy()
    working = working[
        (working["Transport Type"].astype(str).str.strip().str.lower() == base_transport)
        & (working["Medium"].astype(str).str.strip().str.lower() == "road")
        & (working["Vehicle Type"].astype(str).str.strip().str.lower().isin(source_vehicle_types))
    ]
    if drive_filters is not None:
        working = working[
            working["Drive"].astype(str).str.strip().str.lower().isin(drive_filters)
        ]
    if fuel_filter is not None:
        working = working[working["Fuel"].astype(str).str.strip() == fuel_filter]
    if working.empty:
        return []

    tuples = (
        working[["Transport Type", "Medium", "Vehicle Type", "Drive", "Fuel"]]
        .drop_duplicates()
...
def create_new_source_rows_based_on_combinations(source_df):
    ...
    for new_src_tuple, source_tuples_list in COMBINATION_SOURCE_ROWS.items():
        source_tuples_list = _unique_tuples_preserve_order(source_tuples_list)
        inferred_tuples = _infer_additional_road_combination_tuples(source_df, new_src_tuple)
        if inferred_tuples:
            existing = set(source_tuples_list)
            for inferred in inferred_tuples:
                if inferred not in existing:
                    source_tuples_list.append(inferred)
...
NINTH_SOURCE_TO_LEAP_BRANCH_MAP = {
    ...
    ("15_01_domestic_air_transport", "07_petroleum_products", "07_x_jet_fuel"): [
        ("Passenger non road", "Air", "Kerosene type jet fuel"),
        ("Freight non road", "Air", "Kerosene type jet fuel"),
        # Proxy biojet to jet fuel for reconciliation/validation so high-bio runs
        # are not excluded from ESTO matching.
        ("Passenger non road", "Air", "Bio jet kerosene"),
        ("Freight non road", "Air", "Bio jet kerosene"),
    ],
    ...
    ("15_04_domestic_navigation", "07_petroleum_products", "07_01_motor_gasoline"): [
        ("Passenger non road", "Shipping", "Motor gasoline"),
        ("Freight non road", "Shipping", "Motor gasoline"),
        # Proxy shipping biogasoline to motor gasoline for reconciliation/validation.
        ("Passenger non road", "Shipping", "Biogasoline"),
        ("Freight non road", "Shipping", "Biogasoline"),
    ],
    ...
    # ------------------------------------------------------------
    ("15_05_pipeline_transport", "07_petroleum_products", "07_01_motor_gasoline"): [("Nonspecified transport", "Motor gasoline")],
...
UNMAPPABLE_BRANCHES_NO_ESTO_EQUIVALENT = {
    ...
    # Biogas branches (No separate biogas category - would map to Natural gas but creates ambiguity):
    ("Passenger road", "LPVs", "ICE medium", "Biogas"),
    ("Passenger road", "LPVs", "ICE large", "Biogas"),
    ("Passenger road", "Buses", "ICE", "Biogas"),
    ("Freight road", "LCVs", "ICE", "Biogas"),
...
# default_splits_dict = {
#     ("Device Share", "Freight road", "LCVs", "PHEV"): {"Electricity": 50.0, "Gas and diesel oil": 50.0},
#     ("Device Share", "Freight road", "Trucks", "PHEV heavy"): {"Electricity": 50.0, "Gas and diesel oil": 50.0},#etc.
