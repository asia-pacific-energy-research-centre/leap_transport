...
def allocate_fuel_alternatives_energy_and_activity(df, economy, scenario, TRANSPORT_FUELS_DATA_FILE_PATH):
    ...
    biofuel_fuel_map = {
        ...
        'Biogas': 'Natural gas',
        'Efuel-g': 'Motor gasoline',  #efuels repale multiple fuels. not sure how this will work yet
        'Efuel-d': 'Gas and diesel oil',
        'Efuel-j': 'Kerosene type jet fuel',
    }
...
def normalize_and_calculate_shares(df, share_columns_to_source_dict=None, road_only=False):
    ...
    df : pandas.DataFrame
        ...
        ['Economy', 'Scenario', 'Transport Type', 'Medium', 'Vehicle Type', 'Date']
    ...
    # Define grouping levels - most detailed level (keep Economy to avoid cross-economy leakage)
    group_levels = ["Economy", "Scenario", "Transport Type", "Medium", "Vehicle Type", "Date"]
